...
class DistrictTrendAnalyzer:
    ...
    def load_data(self):
        ...
        try:
            self.df = pd.read_excel("reporting_rate_by_adm1.xlsx")
    ...
    def plot_district(self, row):
        ...
        plt.title(f'Yearly Reporting Rate in {district}\n', 
                 fontsize=14, pad=20)
    ...
    def create_zip_file(self, plot_files):
        ...
        with st.spinner("Generating plots..."):
            try:
                ...
                for idx, row in analyzer.df.iterrows():
                    district = row['adm1']
                    st.subheader(f"Reporting Rate Trends for {district}")
                ...
                zip_file = analyzer.create_zip_file(plot_files)
                st.download_button(
